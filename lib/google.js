		...
		async.waterfall([
		    function(callback) {
		    	...
		    	getSubscriptionInfo(url, function(error, response, body){
					...
					callback(null, constants.VALIDATION.SUCCESS);
		    	});
		    	...
		    	switch (state)
		    	{
		    		...
		    		case constants.VALIDATION.FAILURE:
		    			refreshGoogleTokens(function(error, res, body){
		    				...
		    				if(error){
		    					return callback(error, { status: constants.VALIDATION.FAILURE, message: error.message });
		    				}

		    				var parsedBody = JSON.parse(body);
		    				if('error' in parsedBody){
		    					return callback(new Error(parsedBody.error), { status: constants.VALIDATION.FAILURE, message: parsedBody.error});
		    				}

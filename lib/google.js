...
module.exports.readConfig = function (configIn) {
    ...
    // googleAPIKeyData { client_email, private_key } from Google API service account JSON file
    if (config.googleAPIKeyData) {
        useGoogleApi = true;
        googleApi.config(config.googleAPIKeyData);
    }
};
...
module.exports.validatePurchase = function (dPubkey, receipt, cb) {
    ...
    if (useGoogleApi) {
        ...
        */
        return googleApi.validatePurchase(receipt, cb);
    }
